...
import { SCALE_LABELS } from '../lib/diagnostico-engine';
  ...
  return (
    <motion.div key={sector.id} initial={{ opacity: 0, x: 30 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -30 }} transition={{ duration: 0.3 }}>
      <div className="mb-8">
        ...
        <p className="text-slate-500 text-sm mt-1">Avalie cada item de 0 (não existe) a 5 (estratégico e monitorado)</p>
      </div>
